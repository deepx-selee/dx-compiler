...
description: >
  Router agent for DEEPX DX-COM compiler workflows. Classifies incoming tasks
  and dispatches to the appropriate sub-agent: dx-model-converter (PT → ONNX)
...
See `dx_app/.deepx/memory/common_pitfalls.md` Pitfall #19 for the complete
auto-detect code pattern. See `dx-compiler/.deepx/memory/common_pitfalls.md`
...
See `dx_app/.deepx/memory/common_pitfalls.md` Pitfall #20 for the full
